...
import { ValidationStub, AuthenticationSpy, SaveAccessTokenMock, Helper } from '@/tests/application/presentation/mocks'
...
describe('Login Component', () => {
  ...
  test('Should not call Authentication if for is invalid', async () => {
    const validationError = faker.random.words()
